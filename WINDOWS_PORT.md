...
For the **original Apache Gluten README** (what the project is, supported backends, general docs), see [`README.md`](README.md) or the [upstream repo](https://github.com/apache/incubator-gluten).
